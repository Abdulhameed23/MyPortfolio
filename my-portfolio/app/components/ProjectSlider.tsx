...
const ProjectSlider = () => {
  return (
    <div className='sm:px-0 px-2 flex flex-col gap-20'>
        <div className='my-5 bg-[#008282] p-5 rounded-lg lg:rounded-[30px] text-white flex flex-col lg:flex-row lg:gap-8 
        lg:py-16 lg:mx-10 items-center justify-center lg:justify-normal lg:items-start shadow-md shadow-gray-400 
        hover:shadow-xl hover:shadow-gray-500  transition ease-in-out delay-100 duration-300 hover:-translate-y-2'>
            <Image className='lg:w-3/5 rounded-[20px]' src={capstone1} alt="exzbt1" />
            <div className=''>
                <div className='my-4 text-center text-black font-bold text-4xl lg:text-6xl'>EX-ZBT</div>
                <div className='text-md lg:text-xl'>
                    ...
                    and video comments. 
                    <span className='text-yellow-300 font-bold'> VIEW: </span>   
                </div> 
                <Link className='' href={"https://github.com/Abdulhameed23/EXZBT"}>
                    <Image className='mx-auto mt-5 hover:border-2 hover:rounded-full hover:border-yellow-300' src={githubLogo} alt="githubLogo" />
                </Link>
            </div>
        </div>
        <div className='my-5 bg-[#008282] p-5 rounded-lg lg:rounded-[30px] text-white flex flex-col lg:flex-row lg:gap-8 
        ...
        hover:shadow-xl hover:shadow-gray-500 transition ease-in-out delay-100 duration-300 hover:-translate-y-2'>
            ...
            <div>
                <div className='my-4 text-center text-black font-bold text-4xl lg:text-6xl'>G-UNITED</div>
                <div className='text-md lg:text-xl'>
        ...
        hover:shadow-xl hover:shadow-gray-500 transition ease-in-out delay-100 duration-300 hover:-translate-y-2'>
            ...
            <div>
                <div className='my-4 text-center text-black font-bold text-4xl'>HARVEY: A CHATBOT</div>
                <div className='text-md lg:text-xl'>
